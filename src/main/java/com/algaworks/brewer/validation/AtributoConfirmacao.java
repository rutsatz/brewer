...
/*
 * Somente pode usar essa anotação em classes. Pois como preciso de mais de um
 * atributo da classe, preciso ter acesso aos seus atributos.
 */
@Target({ ElementType.TYPE })
@Retention(RetentionPolicy.RUNTIME)
/* Passamos a classe que implementa a regra de validação. */
